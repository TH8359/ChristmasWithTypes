...
namespace ChristmasWithTypes
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //TODO set Santa's name to Kris Kringle [COMPLETE]
            xmas.Santa = "Kris Kringle";

            //TODO Insert 3 presents you would like for xmas.  They must be strings [COMPLETE]
            xmas.Presents =  new string[3]{ "Bike", "Sunglasses", "Laptop" }; 

            //TODO Set the TreeHeight to 10 [COMPLETE]
            xmas.TreeHeight = 10;
